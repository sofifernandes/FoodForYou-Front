...
export class AuthService {
  ...
  logar(userLogin: UserLogin) {
    return this.http.post('https://physical-sponge-production.up.railway.app/usuario/logar', userLogin)
  }

  cadastrar(user: User) {
    return this.http.post('https://physical-sponge-production.up.railway.app/usuario/cadastrar', user)
  }
